...
def build_manifest() -> dict:
    ...
    entries = [
        {"id": "P13-T01", "delivery": "completed", "evidence": ["I", "K", "E"]},
        {"id": "P13-T02", "delivery": "completed", "evidence": ["I"]},
        {"id": "P13-T03", "delivery": "completed", "evidence": ["I", "E"]},
        {"id": "P13-T04", "delivery": "completed", "evidence": ["I", "K"]},
    ...
    return {
        ...
        "finite_evidence": {
            ...
            "negative_profiles": ["failure", "overlap", "cycle"],
        },
        "boundaries": {
            "architecture": "A",
            "production": "I",
